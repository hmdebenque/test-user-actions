...
import org.talend.preparation.actions.DataprepSuggestion;
...
import static org.talend.preparation.actions.ColumnPredicates.*;
 ...
 **/
@DataprepAction
public class UserAction1 extends UserActionMetadataTemplate implements ColumnAction {

    private static final Logger LOG = LoggerFactory.getLogger(UserAction1.class);
